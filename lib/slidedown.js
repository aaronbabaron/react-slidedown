...
var SlideDownComponent = function (props) {
    ...
    return (react_1.default.createElement(TransitionGroup_1.default, null, children && (react_1.default.createElement(SlideDownContent, tslib_1.__assign({ key: "content" }, attrs), children))));
};
